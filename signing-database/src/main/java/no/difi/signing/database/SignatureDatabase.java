...
public class SignatureDatabase {
    ...
    public SignatureDatabase() {
        try {
            ...
            System.err.println("Exception caught in no.difi.signing.database.SignatureDatabase.no.difi.signing.database.SignatureDatabase(): " + e);
            e.printStackTrace();
        }
    }
    ...
    public boolean createTable() {
        try {
            ...
            System.err.println("SQLException caught in no.difi.signing.database.SignatureDatabase.createTable()" + e);
            e.printStackTrace();
            return false;
        }
    }
    ...
    public void insertSignature(SignatureJobModel signatureJob) {
        ...
        try {
            ...
            System.err.println("SQLException caught in no.difi.signing.database.SignatureDatabase.insertSignature(): " + e);
            e.printStackTrace();
        }
    ...
    */
    ...
    public String getSignatureJob(SignatureJobModel signatureJob) {
        ...
        try {
            ...
            System.err.println("SQLException caught in no.difi.signing.database.SignatureDatabase.getSignatureJob()" + e);
            e.printStackTrace();
        }
        return null;
    }
    ...
    public String getSigner(String sender) {
        ...
        try {
            ...
            System.err.println("SQLException caught in no.difi.signing.database.SignatureDatabase.getSigner()" + e);
            e.printStackTrace();
        }
        return null;
    }
    ...
    public void updateStatus(SignatureJobModel signatureJob, String value) {
        if(signatureJob != null){
            ...
            try {
                ...
                System.err.println("SQLException caught in no.difi.signing.database.SignatureDatabase.updateStatus()" + e);
            }
        }
        else{
